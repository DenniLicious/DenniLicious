...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>Välkommen till Kompetensportalen</h1>
            <p>För att komma åt det anpassade innehållet på Kompetensportalen måste du välja användar-typ. <br />
                När du har valt användare får du tillgång till det testet som du ska genomföra.<br />
                Lite mer info om vad Kompetensportalen är och hur du använder den.</p>
</asp:Content>
